...
$aksi="jenis/proses.php";
                    ...
                    switch($p){
default:
echo "<div class='panel panel-border panel-danger'>
                                    <div class='panel-heading'> 
                                        <h3 class='panel-title'><i class='fa fa-list'></i> Data Jenis Laundry</h3> 
                                    </div>  <div class='panel-body'> 
									<p align='right'><a class='btn btn-danger' href='?p=jenis&aksi=tambah'><i class='icon-plus'></i>Tambah Jenis Laundry</a></p>
                                   <hr>
